...
const wordListService = {
  ...
  pickWord: () => {
    ...
    return wordListService.hashCode(word);
  },
...
function convertToIdList() {
  let wordId = {};
  wordList.forEach(word => (wordId[wordListService.hashCode(word)] = word));
  return wordId;
}

const wordIdList = convertToIdList();
